...
description: ide/0.2.0 lags behind package 0.8.0 — do not regenerate casually
resource: /ide
...
Package version is **0.8.0**, but committed IDE stubs still live under `ide/0.2.0/`.[^ide-020][^composer]
...
- Do **not** regenerate or invent `ide/0.8.0/` stubs as part of routine OKF/docs work unless Angel explicitly asks.
