...
resource: /ext
tags: [ftdi, trap, packaging, zephir]
status: draft
...
Version string bumps (e.g. `PHP_FTDI_VERSION` in `ext/php_ftdi.h`) are an explicit maintainer edit — not a license to regenerate the whole tree in place.[^php-h]
