...
# Installer for the FTDI extension on macOS.
# - Resolves PHP binary and extension dir correctly (handles Herd, asdf, etc.)
# - Generates C sources via Zephir, then compiles against libftdi1 and installs manually.
...
echo "=========================================="
echo " FTDI Extension Installer (macOS)"
echo "=========================================="
echo ""
