...
class FTDIContext
{
    ...
    public function toArray() -> array
    {
        return [
            ...
            "usbReadTimeout":     this->usbReadTimeout,
            "usbWriteTimeout":    this->usbWriteTimeout,
            "interfaceIndex":     this->interfaceIndex,
            "baudrate":           this->baudrate,
            "bitbangEnabled":     this->bitbangEnabled,
            "bitbangMode":        this->bitbangMode,
            "channel":            this->channel,
            "inEndpoint":         this->inEndpoint,
            "outEndpoint":        this->outEndpoint,
            "readBufferChunkSize":  this->readBufferChunkSize,
            "writeBufferChunkSize": this->writeBufferChunkSize,
            "maxPacketSize":      this->maxPacketSize,
            "moduleDetachMode":   this->moduleDetachMode,
